...
import com.projetos.bussinescard.data.BusinessCard
import com.projetos.bussinescard.databinding.ItemBusinessCardBinding
...
class BusinessCardAdapter:
    ...
    inner class ViewHolder(
        ...
        fun bind (item: BusinessCard){
            ...
            binding.tvNameEnterprise.text = item.empresa
